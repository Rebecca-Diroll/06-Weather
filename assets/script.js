...
var cityNameCountSpan = document.querySelector("#city-name-count-span");

var cityName;
var cityNames = [];


saveBtn.addEventListener("click", createCityNameList());


// This function puts city names into a list as <li> elements.
function createCityNameList(cityName) {

    // Clear the cityNameList element and update cityNameCountSpan.
    cityNameList.innerHTML = "";
    cityNameCountSpan.textContent = cityNames.length;

    // Create a new <li> element for each city name
    for (var i = 0; i < cityNames.length; i++) {
        ...
        createCityNameList(inputCityName.value);
...
function retreiveData() {
    ...
    fetch("http://api.openweathermap.org/data/2.5/weather?q=" + inputCityName.value + "&units=imperial" +
